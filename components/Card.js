...
const Card = ({ item }) => {
  const styles = {
    ...
    card: `h-[200px] w-[170px] rounded-3xl flex cursor-pointer shadow-lg shadow-purple-500/50  transition-all duration-300  hover:scale-150 hover:shadow-xl overflow-hidden border border-black shadow-xl `,
